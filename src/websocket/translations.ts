...
export const WS_UPDATE_STATE = 'WS_UPDATE_STATE'
export interface WSUpdateStateEvent { type: typeof WS_UPDATE_STATE, payload: MasterState }
export const wsUpdateState = (
  payload: MasterState
): WSUpdateStateEvent => ({ type: WS_UPDATE_STATE, payload })
